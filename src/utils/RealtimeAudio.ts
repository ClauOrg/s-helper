...
export class RealtimeChat {
  ...
  constructor(
    ...
    private onConnectionStateChange: (state: 'connected' | 'disconnected' | 'error') => void
  ) {
  ...
  async init() {
    try {
      ...
      const tokenResponse = await fetch(`https://vxsfjofnyzwhlqxavdpy.functions.supabase.co/get-openai-token`, {
        method: 'POST',
        headers: {
